...
public class WeatherStringWords {
...
//   Please take umbrella and coat, thanks!
        ...
        System.out.println("Enter the weather outside from the list: rainy, snowy, sunny");
        String weather = sc.next();

        System.out.println("Enter Temperature Outside");
        double temperature = sc.nextDouble();

        if (weather.equals("rainy") && (temperature < 50)) {
            thingsToTake = "Umbrella and coat";

        } else if (weather.equals("rainy") && (temperature > 50)) {
            thingsToTake = "Umbrella";

        } else if (weather.equals("snowy") && (temperature < 50)) {
            thingsToTake = "Umbrella and coat";
            ...
            thingsToTake = "Sunglasses and coat";
        }
